...
import com.azki.security.JwtService;
...
class TokenIssuerTest {
    ...
    @BeforeEach
    void setUp() {
        tokenIssuer = new TokenIssuer(TEST_SECRET, TEST_EXPIRATION_MS);
    ...
    void shouldGenerateTokenContainingUserIdUsernameAndRole() {
        ...
        // when
        String token = tokenIssuer.generateToken(userId, username, role);
    ...
    void shouldGenerateValidToken() {
        // given
        String token = tokenIssuer.generateToken("user-id-123", "nima_test", "CUSTOMER");
